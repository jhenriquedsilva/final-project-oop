...
public enum Produtos {
    ...
    BANANA(1.90, "Banana", "Frutas", 1), LARANJA(0.95, "Laranja", "Frutas", 2), ACEROLA(10.9, "Acerola", "Frutas", 3), MACA(2.99, "Maca", "Frutas", 4), MELAO(5.80, "Melão", "Frutas", 5),
    ...
    public String toString() {
        return String.format(Cores.ANSI_GREEN_2 + "[%d]%s: R$%.2f" + Cores.ANSI_RESET, id, nome, valor);
    }
